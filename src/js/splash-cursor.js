/* ================================================
   SPLASH-CURSOR.JS — Interactive WebGL Fluid Splash Cursor
   
   To disable or remove this effect at any time,
   simply comment out or delete the script inclusion in index.html:
   <script src="src/js/splash-cursor.js" defer></script>
   ================================================ */

(function () {
  'use strict';

  // Config parameters matching the custom props:
  ...
  // Create fixed container & canvas
  const container = document.createElement('div');
  container.id = 'splashCursorContainer';
  container.style.cssText = 'position:fixed;inset:0;z-index:2;pointer-events:none;width:100%;height:100%;';
